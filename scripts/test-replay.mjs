...
const env={...process.env,PLAYWRIGHT_BROWSER:'chromium',DOOM_REPLAY_WEBGL:'1',DOOM_TRACE_DEMOS:demos.length?demos.join(','):process.env.DOOM_TRACE_DEMOS??'DEMO1,DEMO2,DEMO3,DEMO4',DOOM_TRACE_TICS:process.env.DOOM_TRACE_TICS??'4000',DOOM_TRACE_SPEED:process.env.DOOM_TRACE_SPEED??'8'};
delete env.PLAYWRIGHT_CHANNEL;
console.log('Replay diagnostics: Playwright bundled Chromium with WebGL; '+env.DOOM_TRACE_DEMOS);
