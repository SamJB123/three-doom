...
|---|---|---|
| Tagged doors — `EV_DoDoor`, `T_VerticalDoor` | `special-lifecycle.test.ts`: 2, 86, 103, 61, 109, 112, 115, 3, 42, 75, 4, 29, 63, 90, 105, 114, 16, 76; speed, endpoints, 150/1050-tic waits, busy retrigger, consumption and removal | Campaign obstruction combinations |
...
| Lifts — `EV_DoPlat`, `T_PlatRaise` | Lifecycle: 10, 21, 62, 88, 120, 123; descent, 105-tic wait, return, removal and repeat activation; specials: perpetual stop/resume and competing floor | Full perpetual cycles and obstructed returns in campaign |
...
| Crushers — `EV_DoCeiling`, `T_MoveCeiling` | Lifecycle: 25, 73, 77 reach eight-unit bottom, reverse, stop via 74 and resume without duplicate thinker. Physics: live damage, blood, dropped objects, corpse gibs; saves: active/stopped continuation | Additional ceiling endpoint/obstruction combinations |
| Stairs — `EV_BuildStairs` | Lifecycle: 7, 8, 127; increasing steps, slow/fast speeds, texture boundary and sector release | Busy/branched chains in actual maps |
