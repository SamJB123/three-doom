...
| LOOP-02 | `P_RunThinkers`, `P_PlayerThink`, ticcmd ordering | partial: original C DEMO1 captured player/actor state matches through tic 108; sliding diverges at 109 | Match C action ordering, RNG consumption, input quantization and deterministic state traces |
