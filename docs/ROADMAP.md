...
| LOOP-02 | `P_RunThinkers`, `P_PlayerThink`, ticcmd ordering | partial: DEMO1 350-tic C actor/target, inventory and sector comparison passes; other episode demos expose gaps | Match C action ordering, RNG consumption, input quantization and deterministic state traces |
