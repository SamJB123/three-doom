...
| UI-01 | `st_stuff.c`, `hu_stuff.c`, `am_map.c` | partial: attacker-directed faces and source face timers checked | HUD state/timing and messages; automap; palette/power effects |
