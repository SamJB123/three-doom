...
| UI-01 | `st_stuff.c`, `hu_stuff.c`, `am_map.c` | partial: attacker-directed faces/timers checked; PLAYPAL colors checked in Chrome/WebKit | HUD state/timing and messages; automap; palette/power effects |
