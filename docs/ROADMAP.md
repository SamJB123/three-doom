...
| LOOP-02 | `P_RunThinkers`, `P_PlayerThink`, ticcmd ordering | partial: original C DEMO1 captured player/actor state matches through tic 209; shot effects diverge at 210 | Match C action ordering, RNG consumption, input quantization and deterministic state traces |
