...
| LOOP-02 | `P_RunThinkers`, `P_PlayerThink`, ticcmd ordering | partial: DEMO1–3 350-tic C actor/target, inventory and sector comparisons pass; DEMO4 first diverges at tic 158 | Match C action ordering, RNG consumption, input quantization and deterministic state traces |
