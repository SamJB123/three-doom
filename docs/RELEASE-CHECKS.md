...
| UI-01 / UI-02 / UI-03 | HUD face/palette/automap, messages, all intermissions/finales, original title/credit/demo sequence | Connected presentation checks pass; title cycle and broader visual comparison pending |
